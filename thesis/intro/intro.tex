...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{lifecycle.pdf} %REMOVE%
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{genome.png} %REMOVE%
...
%http://www.medscape.com/viewarticle/715166_2
	Immunoassays provide cheap immediate testing of HIV infection in patients. These tests are based on the enzyme-linked immunosorbent assay, using an enzyme linked to an antibody to produce a detectable signal in the presence of antigen \citep{Yalow1960,Engvall1971,Weemen1971}. %If the labeled antibodies are targeted to human antibodies then a patient's immune response to an antigen can be measured.
