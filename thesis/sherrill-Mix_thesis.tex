...
\usepackage[pdftitle={Scott Sherrill-Mix thesis},pdfauthor={Scott Sherrill-Mix},hidelinks]{hyperref}  %[[update with title]]
...
\def\myauthor{Scott Sherrill-Mix} \def\myauthorfull{Scott Allen Sherrill-Mix}
\def\mysupervisorname{Frederic D. Bushman, Ph.D.}
\def\mysupervisortitle{Professor, Microbiology}
...
\def\gradchairtitle{Associate Professor, Pathology and Laboratory Medicine}
...
\begin{titlepage}
	...
	Nancy Zhang, Ph.D. Associate Professor of Statistics%, University of Pennsylvania

	Yoseph Barash, Ph.D., Assistant Professor of Genetics,% University of Pennsylvania

	Kristen W. Lynch, Ph.D., Professor of Biochemistry and Biophysics%, University of Pennsylvania
